...
public class CurrencyOperations {
    ...
    public static BigDecimal calculateDiscountAmount (BigDecimal preDiscountCharge, BigDecimal discountPercentage) {
         ...
         * Multiply the two parameters, precision of the result may or may not have increased, though the scales should be the same.
         * Next we shift the decimal point 2 to the left, effectively dividing by 100.  In all cases the scale of the new number
         * should now be 4.  This value gets stored for later steps.  Return a value that is rounded to the n - 2 precision, where
         * n is the precision of the result.  This should yeild a value still with scale 2, that has any amount of precision to
