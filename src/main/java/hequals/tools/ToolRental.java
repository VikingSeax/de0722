...
public class ToolRental {
    ...
    public static String[] checkValuesAndProceed(ToolCode toolCode, int rentalDays, BigDecimal discountPercentage, LocalDate checkOutDate) throws InvalidRentalDaysException, PercentageOutOfBoundsException {
